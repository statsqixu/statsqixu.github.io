(()=>{const a=document.getElementById("slide-ray-approximation"),e=document.getElementById("slide-30");if(!a||!e)return;document.getElementById("slide-ray-analogies")?.remove(),document.getElementById("slide-ray-properties")?.remove(),document.getElementById("slide-ray-efficiency")?.remove(),document.getElementById("slide-ray-gap-bound")?.remove(),document.getElementById("slide-ray-summary")?.remove(),e.remove();const t=document.createElement("section");t.id="slide-ray-analogies",t.className="slide content-slide ray-analogy-slide",t.innerHTML=String.raw`
  ...
  `,t.append(document.createComment("[Sources] Blei, Kucukelbir, and McAuliffe (2017), JASA 112:859-877; Varin, Reid, and Firth (2011), Statistica Sinica 21:5-42; Xu et al. (2026+), manuscript Section 2.2."));const r=document.createElement("section");r.id="slide-ray-properties",r.className="slide content-slide ray-properties-slide",r.innerHTML=String.raw`
    ...
    <span class="slide-number"></span>
  `,r.append(document.createComment("[Sources] Xu et al. (2026+), manuscript Proposition 1 and Theorem 2, Section 2.3."));const s=document.createElement("section");s.id="slide-ray-efficiency",s.className="slide content-slide ray-efficiency-slide",s.innerHTML=String.raw`
    ...
    <span class="slide-number"></span>
  `,s.append(document.createComment("[Sources] Xu et al. (2026+), manuscript Section 3.1, Definition 1 and Theorem 5."));const n=document.createElement("section");n.id="slide-ray-gap-bound",n.className="slide content-slide ray-gap-bound-slide",n.innerHTML=String.raw`
    ...
    <span class="slide-number"></span>
  `,n.append(document.createComment("[Sources] Xu et al. (2026+), manuscript Section 3.2, Definition 2 and Theorem 6."));const i=document.createElement("section");i.id="slide-ray-summary",i.className="slide content-slide ray-summary-slide",i.innerHTML=String.raw`
    ...
    <span class="slide-number"></span>
  `,i.append(document.createComment("[Sources] Xu et al. (2026+), manuscript Sections 1.2, 2.4, 4-6, and Appendix A.")),a.after(t,r,s,n,i);const p=Array.from(document.querySelectorAll("#deck .slide"));p.forEach(((a,e)=>{const t=a.querySelector(".slide-number");t&&(t.textContent=`${e+1} / ${p.length}`)}))})();