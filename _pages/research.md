...
<div id="publications-container">
  ...
  <div class="publication" data-type="Publication">
    <p>
      <strong>Q.Xu</strong>, H.Fu, A.Qu. (2024) <strong>Optimal Individualized Treatment Rule for Combination Treatments Under Budget Constraints.</strong> <em>Journal of the Royal Statistical Society: Series B</em>, 86(3), 714-741. <em>(2023 ASA Nonparametric Statistics Student Paper Award; 2023 IMS Hannan Graduate Student Travel Award)</em> [<a href="https://arxiv.org/abs/2303.11507">Arxiv</a>] [<a href="https://academic.oup.com/jrsssb/advance-article-abstract/doi/10.1093/jrsssb/qkad141/7514594?redirectedFrom=fulltext">Journal</a>] [<a href="https://github.com/statsqixu/DEM">Code</a>]
      <span class="publication-tags">
        <span class="tag" data-tag="Decision Making">Decision Making</span>
        <span class="tag" data-tag="Causal Inference">Causal Inference</span>
        <span class="tag" data-tag="Combination Treatments">Combination Treatments</span>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  tags.forEach(tag => {
    tag.addEventListener('click', function() {
      ...
      filterPublications('tag', selectedTag);
  ...
  filterBtns.forEach(btn => {
    btn.addEventListener('click', function() {
      ...
      filterPublications('type', selectedType);
      showAllBtn.style.display = 'block';
    });
  });
  ...
  function filterPublications(filterBy, value) {
    publications.forEach(pub => {
      if (filterBy === 'tag') {
        const pubTags = pub.querySelectorAll('.tag');
        const hasTag = Array.from(pubTags).some(t => t.getAttribute('data-tag') === value);
        pub.style.display = hasTag ? 'block' : 'none';
      } else if (filterBy === 'type') {
        const pubType = pub.getAttribute('data-type');
        pub.style.display = pubType === value ? 'block' : 'none';
      }
    });
  }
});
